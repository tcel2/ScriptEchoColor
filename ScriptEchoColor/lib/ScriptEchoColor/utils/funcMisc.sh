...
#	declare -g SECnPidDaemon=0
	while ! ${1+false} && [[ "${1:0:2}" == "--" ]];do
		...
		elif [[ "$1" == "--getdaemonpid" ]];then #SECFUNCuniqueLock_help output the value of SECnPidDaemon, 0 if daemon is not running
			lbGetDaemonPid=true
